...
class GUI():
    ...
    def __init__(self,master):
        ...
        self.label=Label(text="Password Generator",fg='blue',font='elephant 35 underline bold')
        ...
        self.generate=Button(text="Generate Password",bd=4,relief='solid',padx=1,pady=1,font='times 25 bold',fg='maroon',bg='limegreen',command=self.generate_pass)
        self.generate.grid(row=12,column=0)


        self.reset=Button(text="Reset",bd=4,relief='solid',padx=1,pady=1,font='times 25 bold',fg='darkblue',bg='red',command=self.reset_fields)
